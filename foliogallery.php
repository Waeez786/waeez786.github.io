...
{		
	...
	else
	{
		...
		<a href="#" class="toright" rel="<?php echo $numAlbums; ?>">Next&nbsp; <span class="icon-right-dir"></span></a>
		<a href="#" class="toleft nolink" rel="<?php echo $numAlbums; ?>"><span class="icon-left-dir"></span> &nbsp;Prev</a>
...
else //display photos in album 
{
	...
	<?php } ?>
	<span class="title m4-left"><?php echo $requested_album; ?> - <?php echo $numFiles; ?> images</span>
	...
	{			
		...
		<a href="#" class="toright" rel="<?php echo $numFiles; ?>">Next&nbsp; <span class="icon-right-dir"></span></a>
		<a href="#" class="toleft nolink" rel="<?php echo $numFiles; ?>"><span class="icon-left-dir"></span> &nbsp;Prev</a>
