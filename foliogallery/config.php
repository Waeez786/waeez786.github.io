...
$thumb_width         = '160';   // used in thumnail creation - use .thumb class in CSS file to style thumbnails
...
$showExiff           = TRUE;    // TRUE will display exiff info of image in image view
